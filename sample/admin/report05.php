        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-dark navbar-dark">
                ...
                <a href="manager.php" class="nav-item nav-link "><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                    <a href="complain4.php" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>put Complaint</a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <ul>
                            ...
                            <a href="documentGm1.php" class="dropdown-item nav-link"><i class='fas fa-file-invoice fa-lg'></i>Final Report</a>
                        </ul>
                        </div>
                    </div>
