        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-dark navbar-dark">
                ...
                <a href="dashboard.php" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                                ...
                                <a href="invoice1.php" class="dropdown-item nav-link active"><i class='fas fa-file-invoice fa-lg'></i>Invoice Details</a>
...
?>
    ...
    <section>
        ...
        <div class="container">
        <a href="document2.php" class="btn btn-info" role="button">Summery</a>
          ...
          <label class="btn btn-success"><li class="fa fa-check" >Done</li></label></td>
             ...
             " onclick="return confirm('are you sure want to remove this item?');">
               <i class="fa fa-trash" style=color:red></i>
                    ...
                    &nbsp;&nbsp; 
                    <a  href="display_pdf4.php?view=<?php echo $row['complain_id'];?>"><i class="fa fa-eye" aria-hidden="true" style=color:purple></i> </a></label>&nbsp;&nbsp;&nbsp;</td>
