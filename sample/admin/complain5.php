...
<body>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-dark navbar-dark">
                ...
                <a href="finance.php" class="nav-item nav-link "><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a> 
                    <a href="complain5.php" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>put Complaint</a>
    ...
    <section class="appoinment">
        ...
        <div class="btn-group">
    <a href="report06.php" class="btn btn-primary active">
