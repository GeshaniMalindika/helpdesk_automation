            ...
            <nav class="navbar bg-dark navbar-dark">
                ...
                <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                           <Ul> <a href="status.php" class="dropdown-item nav-link active"><i class='fas fa-file-invoice fa-lg'></i>Profoma Invoice</a>
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    if(isset($_GET['search']))
                                    {
                                        ...
                                        $query = "SELECT * FROM invoice WHERE CONCAT(id,pdf) LIKE '%$filtervalues%' ";
...
<center>
  ...
  <hr>        
    ...
    $sql = "SELECT * from invoice where approve='1' and status='1'";
