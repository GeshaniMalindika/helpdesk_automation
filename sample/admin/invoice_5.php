    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-dark navbar-dark">
                ...
                <a href="invoice_5.php" class="nav-item nav-link active" ><i class="fa fa-laptop me-2"></i>Invoice Summery</a>
...
?>
    ...
    <section>
        ...
        <div class="container">
        <a href="document_r.php" class="btn btn-info" role="button">Summery</a>
             ...
             if($result)
                 while($row=mysqli_fetch_assoc($result)){
                    ...
                    <tbody>
                           ...
                           <td> &emsp;&emsp;<a  href="view/it_viewProfoma.php?view=<?php echo $row['complain_id'];?>"><i class="fa fa-eye" aria-hidden="true" style=color:purple></i> </a></label></td>
          ...
          <label class="btn btn-success"><li class="fa fa-check" >Done</li></label></td>
             ...
             " onclick="return confirm('are you sure want to remove this item?');">
               <i class="fa fa-trash" style=color:red></i>
                    ...
                    &nbsp;&nbsp; 
                    <a  href="view/it_view.php?view=<?php echo $row['complain_id'];?>"><i class="fa fa-eye" aria-hidden="true" style=color:purple></i> </a></label>&nbsp;&nbsp;&nbsp;</td>
