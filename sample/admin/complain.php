<?php
    ...
    $sql = "SELECT * from asset_user where email = '".$_SESSION['email']."'";
    ...
    if(isset($_POST['submit'])){
       ...
       // $date=$_POST['date'];
        ...
        $sql="insert into `complain` (emp_id,title,emp_name,contact_no,email,unit,description,asset_id) values('$emp_id','$title','$emp_name','$contact_no','$email','$unit','$description','$asset_id')";
        $result=mysqli_query($con,$sql);
...
<nav class="navbar navbar-white bg-light">
    ...
    <a href="profile.php" class="btn-area">Back</a>
</header>
            ...
            <form method="post">
                ...
                <div class="input-box">
                    ...
                    <div class="input-box">
                        ...
                        <input type="text" placeholder="Enter your email" name="email" required readonly
