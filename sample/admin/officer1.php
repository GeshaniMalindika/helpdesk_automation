...
/*   require("../connection/connect.php");
    if(isset($_POST['submit'])){
        ...
        $sql="insert into `it_officer` (emp_id,emp_name,contact_no,username,address,devision) values('$emp_id','$emp_name','$contact_no','$username','$address','$devision')";
        $result=mysqli_query($con,$sql);
        if($result){
            header('location:../officer1.php');
        }
        else{
    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-dark navbar-dark">
                ...
                <a href="officer1.php" class="nav-item nav-link active" ><i class="fa fa-laptop me-2"></i>Officer List</a>
...
?>
  ...
  <table class="table">
                <thead>
                    ...
                    <?php
                    $sql="select * from `asset_user` where user_type='it_officer'";
                    $result=mysqli_query($con,$sql);
                    if($result)
