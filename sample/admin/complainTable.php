...
<div class="container"> 
  ...
  <button><a href="complainReport.php">Complaint Summery</a></button>
  <div class="row">
            <div class="col-md-12">
                <div class="card mt-4">
  ...
  <hr>
                 <thead class="thead-dark">
                    ...
                    <th scope="col"> ID</th>
                        ...
                        <th scope="col">Upload P.Invoice & eng:spec</th>
                ...
                $sql = "SELECT * from complain left join invoice ON complain.complain_id=invoice.complain_id ";
...
//Read more: https://javarevisited.blogspot.com/2012/11/how-to-join-three-tables-in-sql-query-mysql-sqlserver.html#ixzz7gUMzeYq3
               // $sql="SELECT Orders.OrderID, Customers.CustomerName, Shippers.ShipperName FROM ((Orders INNER JOIN Customers ON Orders.CustomerID = Customers.CustomerID) INNER JOIN Shippers ON Orders.ShipperID = Shippers.ShipperID)";
                ...
                <tbody>
                        ...
                        <td> <!--<a href="update/checkEdit.php?GetId=<?php echo  $emp_id ?>">Click</a>-->
                        <button style=font-color:'black'><a href="update/checkEdit.php?GetId=<?php echo  $emp_id ?>"><?php echo$checkout=$row['checkout'];?></a></buutton>
                    </td>   
                            <!--<td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <td >&emsp;&nbsp;<a href="update/refEdit.php?GetId=<?php echo  $complain_id ?>"><?php echo$refference_no=$row['refference_no'];?></a>
                             </td>
                            <td>
                            <?php
                            /*$refference_no=$row['refference_no'];
                               if($refference_no== 'not null')
                            ...
                            ?>    
                            <a href="picupload/invoice.php?GetId=<?php echo  $emp_id ?>">&emsp;&emsp;&emsp;<i class="fa fa-upload" aria-hidden="true" style=color:green></i></a></td>
                            ...
                            <td>  <a href="picupload/invoiceDelete.php?remove=<?=$row['complain_id'] ?>" onclick="return confirm('are you sure want to remove this item?');"><i class="fa fa-trash" style=color:red></i>
                       </a></td>
                                <?php } ?>
                            </tr>
