...
<body>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-dark navbar-dark">
                ...
                <a href="procurement.php" class="nav-item nav-link "><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                    <a href="complain3.php" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Put complaint</a>
                    <!--<a href=".php" class="nav-item nav-link "><i class="fa fa-tachometer-alt me-2"></i>Edit Profile</a>-->
                    <a href="invoice_p.php" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Profoma Invoice</a>
    ...
    <section class="appoinment">
        ...
        <div class="btn-group">
    <a href="report04.php" class="btn btn-primary active">
