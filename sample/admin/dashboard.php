...
session_start();
if(!isset($_SESSION['username'])|| $_SESSION['user_type']!="subject"){
...
<!--<div class="container-fluid pt-4 px-4" width="10px" height="15px">
        ...
        <img src="https://www.kindpng.com/picc/m/78-785975_icon-profile-bio-avatar-person-symbol-chat-icon.png" width="50" height="50"class="img" >&nbsp;
        <h6><font  color="red">
        <?php
                ...
                <div class="col-sm-4">
                    <div class="card2 ">
                        ...
                        <button type="button" class="icon-button">
                            <span class="material-icons">notifications</span>
                            <span class="icon-button__badge"><?php
                               $sql = "SELECT * from complain where change=1";
                            ...
                            <h3 class="card-title text-white">Process Complaints</h3>
                ...
                <div class="col-sm-4">
                    <div class="card ">
                        ...
                        <button type="button" class="icon-button">
                            ...
                            <h3 class="card-title text-white">Not-Noted Complaints</h3>
                ...
                <div class="col-sm-4">
                    <div class="card ">
                       ...
                       <button type="button" class="icon-button">
                            <span class="material-icons">notifications</span>
                            <span class="icon-button__badge"><?php
                               $sql = "SELECT * from invoice where approve='0'";
                ...
                <div class="col-sm-4">
                    <div class="card2 ">
                        ...
                        <button type="button" class="icon-button">
                            ...
                            <h3 class="card-title text-white">Approvel P_Invoice</h3>
