...
<body>
    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-dark navbar-dark">
                ...
                <a href="recomend.php" class="nav-item nav-link active "><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
 ...
 <!--<a href="edit_profile.php" class="nav-item nav-link"><i class="fa fa-laptop me-2"></i> Change password</a>  -->
                <!--<a href="complainList.php" class="nav-item nav-link "><i class="fa fa-laptop me-2"></i> User Complaints</a>-->
                    <!--<a href="userTable.php" class="nav-item nav-link"><i class="fa fa-laptop me-2"></i> Users</a>
    
                    
                    
                    <a href="complainTable.php" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i> Complaint List </a>
                    <a href="supplierTable.php" class="nav-item nav-link"><i class="bi bi-clipboard-data me-2"></i>Supplier List</a>
                    ...
                    <a href="officerTable.php" class="nav-item nav-link"><i class="bi bi-clipboard-data me-2"></i>It Officers</a>
                    ...
                    <div class="dropdown-menu bg-transparent border-0">
                        <ul>
                            <a href="invoice.php" class="dropdown-item nav-link"><i class='fas fa-file-invoice fa-lg' S></i>Profoma Invoice</a>
                            <a href="final_report.php" class="dropdown-item nav-link"><i class='fas fa-file-invoice fa-lg'></i>Final Report</a>
                        </ul>
                    </div>
                    </div>
                    <a href="asset_table.php" class="nav-item nav-link"><i class="bi bi-table me-2"></i>Asset Table</a>  -->
                ...
                <div class="col-sm-4">
                    <div class="card ">
                        ...
                        <button type="button" class="icon-button">
                            ...
                            <h3 class="card-title text-white"><br>Asset Users</h3>
                ...
                <div class="col-sm-4">
                    <div class="card2 ">
                        ...
                        <button type="button" class="icon-button">
                            ...
                            <h3 class="card-title text-white"><br> Complaints</h3>
                ...
                <div class="col-sm-4">
                    <div class="card ">
                        ...
                        <button type="button" class="icon-button">
                            ...
                            <h3 class="card-title text-white"><br>Users</h3>
                ...
                <div class="col-sm-4">
                    <div class="card2 ">
                        ...
                        <button type="button" class="icon-button">
                            ...
                            <h3 class="card-title text-white">Approval Final Invoice</h3>
