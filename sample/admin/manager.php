...
session_start();
if(!isset($_SESSION['username'])|| $_SESSION['user_type']=="GM"){
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-dark navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    <a href="manager.php" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                    ...
                    <a href="logout.php" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Logout</a> 
                     <!-- <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="far fa-file-alt me-2"></i>Summery</a>
                      <div class="dropdown-menu bg-transparent border-0">
                        <ul>
                            <a href="documentGm.php" class="dropdown-item nav-link"><i class='fas fa-file-invoice fa-lg' S></i>Profoma Invoice</a>
                    ...
                    <!--<a href="documentGm.php" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>P invoice Summery</a>
                    <a href="documentGm1.php" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>invoice Summery</a>
                    <a href="managerProfile.php" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Change Password</a>-->
...
<?php
    ...
    <span class="icon-button__badge"> <?php
                            ...
                            <h3 class="card-title text-white"><br>Total Profoma Invoice</h3>
    ...
    <span class="material-icons">notifications</span>
    <span class="icon-button__badge"><?php
                               $sql = "SELECT * from invoice where rec1=1 and approve=0";
                            ...
                            <h3 class="card-title text-white">Not approval Invoice</h3>
    ...
    <span class="material-icons">notifications</span>
    <span class="icon-button__badge"> <?php
                               $sql = "SELECT * from invoice where approve=1 ";
                            ...
                            <h3 class="card-title text-white"><br>Approvel Invoice</h3>
    ...
    <span class="material-icons">notifications</span>
    <span class="icon-button__badge"> <?php
                               $sql = "SELECT * from f_invoice  where recomendation=0 ";
                            ...
                            <h3 class="card-title text-white"><br>Not approval Invoice</h3>
    ...
    <span class="icon-button__badge"> <?php
                            ...
                            <h3 class="card-title text-white"><br>Approval Invoice</h3>
