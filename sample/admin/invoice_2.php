...
?>
    ...
    <section>
        ...
        <div class="container">
        <a href="document_p.php" class="btn btn-info" role="button">Summery</a>
             ...
             if($result)
                 while($row=mysqli_fetch_assoc($result)){
                    ...
                    <tbody>
                           ...
                           <!--<td> &emsp;&emsp;<a  href="view/p_view.php?view=<?php echo $row['complain_id'];?>"><i class="fa fa-eye" aria-hidden="true" style=color:purple></i> </a></label></td>-->
          ...
          <label class="btn btn-success"><li class="fa fa-check" >Done</li></label></td>
             ...
             " onclick="return confirm('are you sure want to remove this item?');">
               <i class="fa fa-trash" style=color:red></i>
                    ...
                    &nbsp;&nbsp; 
                    <a  href="view/p_view.php?view=<?php echo $row['complain_id'];?>"><i class="fa fa-eye" aria-hidden="true" style=color:purple></i> </a></label>&nbsp;&nbsp;&nbsp;</td>
