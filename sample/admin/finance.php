...
session_start();
if(!isset($_SESSION['username'])|| $_SESSION['user_type']!="finance"){
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-dark navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    <a href="finance.php" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a> 
                    ...
                    <a href="fList.php" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>List</a> 
                     <!--<a href="fin.php" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Change Password</a> 
...
<!--<div class="container-fluid pt-4 px-4" width="10px" height="15px">
            ...
            <div class="container">
            <center><h6><font color="black">
        <img src="https://www.kindpng.com/picc/m/78-785975_icon-profile-bio-avatar-person-symbol-chat-icon.png" width="50" height="50"class="img" ><br>
       <?php
    ...
    <span class="icon-button__badge"><?php
                            ...
                            <h3 class="card-title text-white">Pending Cheque</h3>
    ...
    <span class="icon-button__badge">   <?php
                            ...
                            <h3 class="card-title text-white">Pay cheque</h3>
    ...
    <span class="icon-button__badge"><?php
                            ...
                            <h3 class="card-title text-white">Profoma Invoice</h3>
    ...
    <span class="icon-button__badge"><?php
                            ...
                            <h3 class="card-title text-white">Approvel Invoice</h3>
