        ...
        <!--<div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-dark navbar-dark">
                ...
                <a href="dashboard.php" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                                ...
                                <a href="invoice1.php" class="dropdown-item nav-link "><i class='fas fa-file-invoice fa-lg'></i>All Invoice</a>
...
<a  href="../invoice.php" ><i class="fa fa-angle-left" style="font-size:46px"><i class="fa fa-angle-left" style="font-size:46px"><i class="fa fa-angle-left" style="font-size:46px"></i></i></i></a>
<center>
<div class="h1">
<?php
        include('config/db.php');
        ...
        if (isset($_POST['submit'])) {
          ...
          if(in_array($file_ext,$extensions)==false){
            ...
            if(empty($error)==true){
                ...
                $pdf_store="./upload/".$pdf;
                $sql="INSERT INTO f_invoice(complain_id,pdf) values('$complain_id','$pdf')";
