<?php
    ...
    $id=$_GET['updateid'];
    $sql="select * from `complain` where emp_id=$emp_id";
    ...
    if(isset($_POST['submit'])){
        ...
        $sql="update `complain` set 'emp_id='$'emp_id',emp_name='$emp_name',contact_no='$contact_no',email='$email',date='$date',complaint='$complaint',unit='$unit' where emp_id=$emp_id";
        $result=mysqli_query($con,$sql);
        if($result){
