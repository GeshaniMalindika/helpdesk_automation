...
require("../connection/connect.php");
    ...
    $query = " select * from f_invoice where complain_id='".$complain_id."'  ";
                ...
                <div class="col-lg-6 m-auto">
                    <div class="card mt-5">
                        ...
                        <div class="card-body">
                            ...
                            <form action="f_invoiceUpdate.php?ID=<?php echo $complain_id ?>" method="post">
                            <input type="text" class="form-control mb-2" placeholder=" id" name="complain_id" value="<?php echo $complain_id ?>">
                            <input type="text" class="form-control mb-2" placeholder=" pdf" name="pdf" value="<?php echo $pdf ?>">
