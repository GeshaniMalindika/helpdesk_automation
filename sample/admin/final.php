    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-dark navbar-dark">
                ...
                <a href="supplier.php" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                     
                <div class="navbar-nav w-100">
                    
                    
                <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="far fa-file-alt me-2"></i>Invoices</a>
                        <div class="dropdown-menu bg-transparent border-0">
                           <Ul> <a href="status.php" class="dropdown-item nav-link"><i class='fas fa-file-invoice fa-lg'></i>Profoma Invoice</a>
                            <a href="final.php" class="dropdown-item nav-link active"><i class='fas fa-file-invoice fa-lg'></i>Invoice</a>
</ul>
                        </div>
                    </div> 
...
<h1>Final Invoice </h1> 
  <div class="row">
           ...
           <!-- <div class="col-md-12">
                <div class="card mt-4">-->
                    <div class="card-body">
                   <!-- <caption><b><u>Profoma Invoice</u></b> </caption> -->
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    if(isset($_GET['search']))
                                    {
                                        ...
                                        $query = "SELECT * FROM invoice WHERE CONCAT(id,pdf,date) LIKE '%$filtervalues%' ";
     ...
     $status=$items['status'];
      ...
      if($status=="0")
     { ?>
  <label class="btn btn-danger"><li class="fa fa-close">not-approved</li></label>
     <?php
     }
     if($status=="1")
     {
                     ?>
  <label class="btn btn-success">You can Repair.!</label></td>
     <?php 
     } 
     ?>
     </td>
  ...
  <table class="table">
        ...
        <thead>
            <tr>
                ...
                <th scope="col">Uploaded <br> Date & Time</th>
                <th scope="col">Message</th>
    ...
    $sql = "SELECT * from f_invoice where status='1' ";
     ...
     $status=$row['status'];
      ...
      if($status=="0")
     { ?>
  <label class="btn btn-danger"><li class="fa fa-close">Process</li></label>
     <?php
     }
     if($status=="1")
     {
                     ?>
  <label class="btn btn-success"><li class="fa fa-check">Finish</li></label></td>
     <?php 
     } 
     ?>
     </td>
