...
.btn{
  ...
  <nav class="navbar navbar-white bg-light">
    ...
    <div class="div1">
      ...
      $sql="SELECT pdf from invoice where complain_id='$_GET[view]' and recomend=1";
    ...
    <a href="invoice_p.php" button type="button" class="btn btn-primary btn-sm">close</button></a>
  </body>
</html>