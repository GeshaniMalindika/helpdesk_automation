        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-dark navbar-dark">
                ...
                <a href="manager.php" class="nav-item nav-link "><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                    ...
                    <a href="manager1.php" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>List</a>
...
?>
  ...
  <table class="table">
                <thead>
                    ...
                    <?php
                    $sql="select * from `asset_user` where user_type='gm'";
                    ...
                    if($result)
                        while($row=mysqli_fetch_assoc($result)){
                            ...
                            <td><?php echo$devision=$row['devision'];?></td>
                              ...
                              <!-- <td>
                               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="update/gmrEdit.php?GetId=<?php echo  $emp_id ?>"><i class="fa fa-edit" style=color:green></i></a>
