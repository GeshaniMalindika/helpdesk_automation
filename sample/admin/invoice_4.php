        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-dark navbar-dark">
                ...
                <a href="finance.php" class="nav-item nav-link "><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a> 
                    ...
                    <a href="invoice_4.php" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Invoice Summery</a> 
...
?>
    ...
    <section>
        ...
        <div class="container">
        <a href="documentGm.php" class="btn btn-info" role="button">Summery</a>
             ...
             if($result)
                 while($row=mysqli_fetch_assoc($result)){
                    ...
                    <tbody>
                           ...
                           <td> &emsp;&emsp;<a  href="view/f_viewProfoma.php?view=<?php echo $row['complain_id'];?>"><i class="fa fa-eye" aria-hidden="true" style=color:purple></i> </a></label></td>
          ...
          <label class="btn btn-success"><li class="fa fa-check" >Done</li></label></td>
             ...
             " onclick="return confirm('are you sure want to remove this item?');">
               <i class="fa fa-trash" style=color:red></i>
                    ...
                    &nbsp;&nbsp; 
                    <a  href="view/f_view.php?view=<?php echo $row['complain_id'];?>"><i class="fa fa-eye" aria-hidden="true" style=color:purple></i> </a></label>&nbsp;&nbsp;&nbsp;</td>
