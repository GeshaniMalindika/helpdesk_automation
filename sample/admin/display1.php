...
.btn{
  ...
  <nav class="navbar navbar-white bg-light">
    ...
    <div class="div1">
      ...
      $sql="SELECT pdf from f_invoice where complain_id='$_GET[view]'";
      $query=mysqli_query($con,$sql);
      while ($info=mysqli_fetch_array($query)) {
        ?>
      <embed type="application/pdf" src="./picupload/upload/<?php echo $info['pdf'] ; ?>" width="1000" height="700":>
    <?php
      }
    ...
    <a href="final_report1.php" button type="button" class="btn btn-primary btn-sm">close</button></a>
