        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-dark navbar-dark">
                ...
                <a href="complain5.php" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>put Complaint</a>
                    <a href="invoice_f.php" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Invoice</a> 
                    
                    <a href="invoice_4.php" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Invoice Summery</a> 
                    <a href="fList.php" class="nav-item nav-link "><i class="fa fa-tachometer-alt me-2"></i>List</a> 
...
<section>
        ...
        <div class="row">
                            ...
                            <div class="col-md-7">
                                ...
                                <form action="" method="GET">
                                    <div class="input-group mb-3">
                                        <input type="text" name="search" required value="<?php if(isset($_GET['search'])){echo $_GET['search']; } ?>" class="form-control" placeholder="Search emp_name or Unit wise" style="background-color:white">
           ...
           <!-- <div class="col-md-12">
                <div class="card mt-4">-->
                    <div class="card-body">
                        ...
                        <th scope="col">IT_officer Recomend</th>
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    if(isset($_GET['search']))
                                    {
                                        ...
                                        $query = "SELECT * FROM complain inner join f_invoice On complain.complain_id=f_invoice.complain_id  WHERE CONCAT(emp_name,unit) LIKE '%$filtervalues%' ";
          ...
          <label class="btn btn-danger"><li class="fa fa-times" >Not </li></label>
             ...
             {
                             ?>
          <label class="btn btn-success"><li class="fa fa-check" >Recomend to Finance</li></label></td>
             <?php 
             } 
             ?>
  ...
  <table class="table"><hr>
                <thead>
                    ...
                    <?php
                    $sql = "SELECT * from complain inner join f_invoice ON complain.complain_id=f_invoice.complain_id where recomendation=1";
                ...
                <td>
                    ...
                    if($row['status']=="0") 
                        ...
                        // green- activate
                    //echo 
                    //"<a href=activate/finish.php?id=".$row['id']." class='button purple'>Job Done</a>";
                    //else 
                       echo 
                       "<a href=dactivate/process.php?complain_id=".$row['complain_id']." class='button purple'>Job Done</a>";
                       else 
echo
 "<i class='fa fa-check' aria-hidden='true'style=color:grey>done</i>";
                    ?>
                        ...
                        <td> 
                           <!-- <a href="delete/FinvoiceDelete.php?remove=<?=$row['id'] ?>" onclick="return confirm('are you sure want to remove this item?');">
                           
                           <i class="fa fa-trash" style=color:red></i>
                       </a> -->&nbsp;&nbsp; &nbsp;&nbsp;
                                <a href="display_pdf3.php?view=<?php echo $row['complain_id'];?>"><i class="fa fa-eye" aria-hidden="true" style="color:purple"></i> </a>
                                  </td>
                                <?php } ?>
                            </tr>
