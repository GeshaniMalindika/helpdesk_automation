...
<button type="button" class="icon-button">
                            ...
                            <span class="icon-button__badge"><?php
                               $sql = "SELECT * from asset_user where user_type=' '";
    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-dark navbar-dark">
                ...
                <a href="user.php" class="nav-item nav-link active"><i class="fa fa-laptop me-2"></i> User Role</a>
...
?>
    <section>
        <div class="container">
           <h3><font color="blue"> <u>Edit User Role </u></font></h3>
                    ...
                    if($result)
                        while($row=mysqli_fetch_assoc($result)){
                            ...
                            <td><?php echo$address=$row['address'];?></td>
                                ...
                                <a href="delete/userDelete1.php?remove=<?=$row['emp_id'] ?>" onclick="return confirm('are you sure want to remove this item?');">
