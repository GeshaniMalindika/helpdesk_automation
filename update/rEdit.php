                ...
                <div class="col-lg-6 m-auto">
                    <div class="card mt-5">
                        ...
                        <div class="card-body">
                            ...
                            <form action="reportUpdate.php?ID=<?php echo $complain_id ?>" method="post">
                           
                                <input type="text" class="form-control mb-2" placeholder=" employee id" name="emp_id" value="<?php echo $emp_id ?>">
